...
const Header = () => {
    return (
        <header className="max-w-7xl mx-auto mt-3 px-5 flex gap-x-5">
            ...
            <div className="flex grow gap-x-2 bg-slate-100 rounded p-2">
                ...
                <input type="text" placeholder="Поиск" className="w-full bg-slate-100"/>
            </div>

                <a className="flex flex-row gap-x-3 my-auto" href="https://github.com/arba-octo/custom-hooks">
                    <span>add hook</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 16" fill="none" width="30" height="30">
                        <g clipPath="url(githublogo)">
                            <path fill="currentColor" fillRule="evenodd"
                                  ...
                                  clipRule="evenodd" className="jsx-120409797"></path>
                        </g>
                        <defs>
                            <clipPath>
                                <path fill="transparent" d="M0 0h15.86v15.86H0z"
                                      transform="translate(.253906 .0493164)"></path>
                            </clipPath>
                        </defs>
                    </svg>
                </a>
